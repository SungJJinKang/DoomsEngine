...
static const int clcppNbTypes = 281;
...
void clcppInitGetType(const clcpp::Database* db)
{
	...
	if (db != 0)
	{
		...
		clcppTypePtrs[174] = db->GetType(0xb3f32d82);
		...
		clcppTypePtrs[199] = db->GetType(0xd52fe831);
		clcppTypePtrs[200] = db->GetType(0xd7199f49);
		clcppTypePtrs[201] = db->GetType(0xd72d9105);
		clcppTypePtrs[202] = db->GetType(0xd76065e6);
		clcppTypePtrs[203] = db->GetType(0xd777e004);
		clcppTypePtrs[204] = db->GetType(0xd85c112c);
		clcppTypePtrs[205] = db->GetType(0xd94c8018);
		clcppTypePtrs[206] = db->GetType(0xd95e1fd8);
		clcppTypePtrs[207] = db->GetType(0xd98bf230);
		clcppTypePtrs[208] = db->GetType(0xda054820);
		...
		clcppTypePtrs[247] = db->GetType(0x2f43d085);
		clcppTypePtrs[248] = db->GetType(0x40a8f2cf);
		clcppTypePtrs[249] = db->GetType(0x431256b9);
		clcppTypePtrs[250] = db->GetType(0x47b8f350);
		clcppTypePtrs[251] = db->GetType(0x5d45f8dd);
		clcppTypePtrs[252] = db->GetType(0x64ac9699);
		clcppTypePtrs[253] = db->GetType(0x7002de90);
		clcppTypePtrs[254] = db->GetType(0x7345a829);
		...
		clcppTypePtrs[266] = db->GetType(0x73da4a);
		clcppTypePtrs[267] = db->GetType(0x815d47a);
		clcppTypePtrs[268] = db->GetType(0x311714bf);
		clcppTypePtrs[269] = db->GetType(0x34a7768f);
		clcppTypePtrs[270] = db->GetType(0x38da33ef);
		clcppTypePtrs[271] = db->GetType(0x49400eb8);
		clcppTypePtrs[272] = db->GetType(0x532220b8);
		clcppTypePtrs[273] = db->GetType(0x68e6d3ff);
		clcppTypePtrs[274] = db->GetType(0x8fd0d24a);
		clcppTypePtrs[275] = db->GetType(0x919d1bf1);
		clcppTypePtrs[276] = db->GetType(0x91ee210a);
		clcppTypePtrs[277] = db->GetType(0x95fb9fe8);
		clcppTypePtrs[278] = db->GetType(0xb7155e0b);
		clcppTypePtrs[279] = db->GetType(0xc058aa24);
		clcppTypePtrs[280] = db->GetType(0xce831ddf);
	}
}
...
namespace clcpp
{
	...
	template <> const Type* GetType< dooms::graphics::Color >() { return clcppTypePtrs[174]; }
	...
	template <> const Type* GetType< dooms::PlainComponent >() { return clcppTypePtrs[199]; }
	template <> unsigned int GetTypeNameHash< dooms::PlainComponent >() { return 0xd52fe831; }
	template <> const Type* GetType< dooms::Collider3DComponent >() { return clcppTypePtrs[200]; }
	template <> unsigned int GetTypeNameHash< dooms::Collider3DComponent >() { return 0xd7199f49; }
	template <> const Type* GetType< ::ImGuiColorMod >() { return clcppTypePtrs[201]; }
	template <> unsigned int GetTypeNameHash< ::ImGuiColorMod >() { return 0xd72d9105; }
	template <> const Type* GetType< dooms::TransformCoreData >() { return clcppTypePtrs[202]; }
	...
	template <> const Type* GetType< dooms::Transform >() { return clcppTypePtrs[205]; }
	template <> unsigned int GetTypeNameHash< dooms::Transform >() { return 0xd94c8018; }
	template <> const Type* GetType< dooms::time::MainTimer >() { return clcppTypePtrs[206]; }
	template <> unsigned int GetTypeNameHash< dooms::time::MainTimer >() { return 0xd95e1fd8; }
	template <> const Type* GetType< dooms::physics::Physics_Server >() { return clcppTypePtrs[207]; }
	template <> unsigned int GetTypeNameHash< dooms::physics::Physics_Server >() { return 0xd98bf230; }
	template <> const Type* GetType< dooms::GameCore >() { return clcppTypePtrs[208]; }
	...
	template <> const Type* GetType< dooms::graphics::eTextureComponentFormat >() { return clcppTypePtrs[247]; }
	template <> unsigned int GetTypeNameHash< dooms::graphics::eTextureComponentFormat >() { return 0x2f43d085; }
	template <> const Type* GetType< dooms::graphics::eTextureCompressedInternalFormat >() { return clcppTypePtrs[248]; }
	template <> unsigned int GetTypeNameHash< dooms::graphics::eTextureCompressedInternalFormat >() { return 0x40a8f2cf; }
	template <> const Type* GetType< dooms::userinput::eKeyState >() { return clcppTypePtrs[249]; }
	template <> unsigned int GetTypeNameHash< dooms::userinput::eKeyState >() { return 0x431256b9; }
	template <> const Type* GetType< dooms::ePrimitiveType >() { return clcppTypePtrs[250]; }
	template <> unsigned int GetTypeNameHash< dooms::ePrimitiveType >() { return 0x47b8f350; }
	template <> const Type* GetType< dooms::userinput::eMouse_Button_Action >() { return clcppTypePtrs[251]; }
	template <> unsigned int GetTypeNameHash< dooms::userinput::eMouse_Button_Action >() { return 0x5d45f8dd; }
	template <> const Type* GetType< dooms::eSpace >() { return clcppTypePtrs[252]; }
	template <> unsigned int GetTypeNameHash< dooms::eSpace >() { return 0x64ac9699; }
	template <> const Type* GetType< dooms::logger::eLogType >() { return clcppTypePtrs[254]; }
	...
	template <> const Type* GetType< void >() { return clcppTypePtrs[266]; }
	template <> unsigned int GetTypeNameHash< void >() { return 0x73da4a; }
	template <> const Type* GetType< unsigned long >() { return clcppTypePtrs[267]; }
	template <> unsigned int GetTypeNameHash< unsigned long >() { return 0x815d47a; }
	template <> const Type* GetType< wchar_t >() { return clcppTypePtrs[268]; }
	template <> unsigned int GetTypeNameHash< wchar_t >() { return 0x311714bf; }
	template <> const Type* GetType< short >() { return clcppTypePtrs[269]; }
	template <> unsigned int GetTypeNameHash< short >() { return 0x34a7768f; }
	template <> const Type* GetType< long >() { return clcppTypePtrs[270]; }
	template <> unsigned int GetTypeNameHash< long >() { return 0x38da33ef; }
	template <> const Type* GetType< unsigned char >() { return clcppTypePtrs[271]; }
	template <> unsigned int GetTypeNameHash< unsigned char >() { return 0x49400eb8; }
	template <> const Type* GetType< long long >() { return clcppTypePtrs[272]; }
	template <> unsigned int GetTypeNameHash< long long >() { return 0x532220b8; }
	template <> const Type* GetType< double >() { return clcppTypePtrs[273]; }
	template <> unsigned int GetTypeNameHash< double >() { return 0x68e6d3ff; }
	template <> const Type* GetType< bool >() { return clcppTypePtrs[274]; }
	template <> unsigned int GetTypeNameHash< bool >() { return 0x8fd0d24a; }
	template <> const Type* GetType< unsigned short >() { return clcppTypePtrs[275]; }
	template <> unsigned int GetTypeNameHash< unsigned short >() { return 0x919d1bf1; }
	template <> const Type* GetType< unsigned int >() { return clcppTypePtrs[276]; }
	template <> unsigned int GetTypeNameHash< unsigned int >() { return 0x91ee210a; }
	template <> const Type* GetType< float >() { return clcppTypePtrs[277]; }
	template <> unsigned int GetTypeNameHash< float >() { return 0x95fb9fe8; }
	template <> const Type* GetType< char >() { return clcppTypePtrs[278]; }
	template <> unsigned int GetTypeNameHash< char >() { return 0xb7155e0b; }
	template <> const Type* GetType< unsigned long long >() { return clcppTypePtrs[279]; }
	template <> unsigned int GetTypeNameHash< unsigned long long >() { return 0xc058aa24; }
	template <> const Type* GetType< int >() { return clcppTypePtrs[280]; }
	...
	template <> const Type* GetType< dooms::TestEnum_ReflectionTest >() { return clcppTypePtrs[253]; }
