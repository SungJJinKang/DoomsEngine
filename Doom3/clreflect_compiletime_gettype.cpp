...
void clcppInitGetType(const clcpp::Database* db)
{
	...
	if (db != 0)
	{
		...
		clcppTypePtrs[81] = db->GetType(0x55a81d81);
		clcppTypePtrs[82] = db->GetType(0x5674fd6e);
		clcppTypePtrs[83] = db->GetType(0x58410fc4);
		clcppTypePtrs[84] = db->GetType(0x58fbcb8e);
		clcppTypePtrs[85] = db->GetType(0x5907e96c);
		...
		clcppTypePtrs[101] = db->GetType(0x69cf54c5);
		...
		clcppTypePtrs[207] = db->GetType(0xdaa77a6b);
		clcppTypePtrs[208] = db->GetType(0xdae6cca0);
		clcppTypePtrs[209] = db->GetType(0xdb49d534);
		clcppTypePtrs[210] = db->GetType(0xdc3bd246);
		clcppTypePtrs[211] = db->GetType(0xdcef8cb1);
		clcppTypePtrs[212] = db->GetType(0xdda9d5fc);
		clcppTypePtrs[213] = db->GetType(0xddadff63);
		...
		clcppTypePtrs[265] = db->GetType(0xf92c31f8);
...
namespace clcpp
{
	...
	template <> const Type* GetType< clcpp::Attribute >() { return clcppTypePtrs[81]; }
	template <> unsigned int GetTypeNameHash< clcpp::Attribute >() { return 0x55a81d81; }
	template <> const Type* GetType< ::ImFontAtlas >() { return clcppTypePtrs[82]; }
	template <> unsigned int GetTypeNameHash< ::ImFontAtlas >() { return 0x5674fd6e; }
	template <> const Type* GetType< ::aiMetadata >() { return clcppTypePtrs[83]; }
	template <> unsigned int GetTypeNameHash< ::aiMetadata >() { return 0x58410fc4; }
	template <> const Type* GetType< clcpp::Function >() { return clcppTypePtrs[84]; }
	template <> unsigned int GetTypeNameHash< clcpp::Function >() { return 0x58fbcb8e; }
	template <> const Type* GetType< ::ImDrawChannel >() { return clcppTypePtrs[85]; }
	...
	template <> const Type* GetType< dooms::graphics::Graphics_Setting >() { return clcppTypePtrs[101]; }
	...
	template <> const Type* GetType< dooms::IGameFlow >() { return clcppTypePtrs[207]; }
	template <> unsigned int GetTypeNameHash< dooms::IGameFlow >() { return 0xdaa77a6b; }
	template <> const Type* GetType< ::ImFont >() { return clcppTypePtrs[208]; }
	template <> unsigned int GetTypeNameHash< ::ImFont >() { return 0xdae6cca0; }
	template <> const Type* GetType< dooms::time::Time_Server >() { return clcppTypePtrs[209]; }
	template <> unsigned int GetTypeNameHash< dooms::time::Time_Server >() { return 0xdb49d534; }
	template <> const Type* GetType< ::ImGuiWindowTempData >() { return clcppTypePtrs[210]; }
	template <> unsigned int GetTypeNameHash< ::ImGuiWindowTempData >() { return 0xdc3bd246; }
	template <> const Type* GetType< dooms::graphics::UniformBufferObjectUpdater >() { return clcppTypePtrs[211]; }
	template <> unsigned int GetTypeNameHash< dooms::graphics::UniformBufferObjectUpdater >() { return 0xdcef8cb1; }
	template <> const Type* GetType< math::Quaternion >() { return clcppTypePtrs[212]; }
	template <> unsigned int GetTypeNameHash< math::Quaternion >() { return 0xdda9d5fc; }
	template <> const Type* GetType< ::ImDrawCmd >() { return clcppTypePtrs[213]; }
	...
	template <> const Type* GetType< dooms::graphics::eVertexArrayFlag >() { return clcppTypePtrs[265]; }
