...
static const int clcppNbTypes = 282;
...
void clcppInitGetType(const clcpp::Database* db)
{
	...
	if (db != 0)
	{
		...
		clcppTypePtrs[256] = db->GetType(0x737a565d);
		clcppTypePtrs[257] = db->GetType(0x774eb9ef);
		clcppTypePtrs[258] = db->GetType(0x7fd56a58);
		clcppTypePtrs[259] = db->GetType(0x8c51022a);
		clcppTypePtrs[260] = db->GetType(0x974301e3);
		clcppTypePtrs[261] = db->GetType(0xb72b574b);
		...
		clcppTypePtrs[267] = db->GetType(0x73da4a);
		clcppTypePtrs[268] = db->GetType(0x815d47a);
		clcppTypePtrs[269] = db->GetType(0x311714bf);
		clcppTypePtrs[270] = db->GetType(0x34a7768f);
		clcppTypePtrs[271] = db->GetType(0x38da33ef);
		clcppTypePtrs[272] = db->GetType(0x49400eb8);
		clcppTypePtrs[273] = db->GetType(0x532220b8);
		clcppTypePtrs[274] = db->GetType(0x68e6d3ff);
		clcppTypePtrs[275] = db->GetType(0x8fd0d24a);
		clcppTypePtrs[276] = db->GetType(0x919d1bf1);
		clcppTypePtrs[277] = db->GetType(0x91ee210a);
		clcppTypePtrs[278] = db->GetType(0x95fb9fe8);
		clcppTypePtrs[279] = db->GetType(0xb7155e0b);
		clcppTypePtrs[280] = db->GetType(0xc058aa24);
		clcppTypePtrs[281] = db->GetType(0xce831ddf);
	}
}
...
namespace clcpp
{
	...
	template <> const Type* GetType< dooms::userinput::eMouse_Button_Type >() { return clcppTypePtrs[256]; }
	template <> unsigned int GetTypeNameHash< dooms::userinput::eMouse_Button_Type >() { return 0x737a565d; }
	template <> const Type* GetType< dooms::asset::eAssetType >() { return clcppTypePtrs[258]; }
	template <> unsigned int GetTypeNameHash< dooms::asset::eAssetType >() { return 0x7fd56a58; }
	template <> const Type* GetType< dooms::graphics::eTextureInternalFormat >() { return clcppTypePtrs[260]; }
	template <> unsigned int GetTypeNameHash< dooms::graphics::eTextureInternalFormat >() { return 0x974301e3; }
	template <> const Type* GetType< dooms::userinput::eKEY_CODE >() { return clcppTypePtrs[261]; }
	...
	template <> const Type* GetType< void >() { return clcppTypePtrs[267]; }
	template <> unsigned int GetTypeNameHash< void >() { return 0x73da4a; }
	template <> const Type* GetType< unsigned long >() { return clcppTypePtrs[268]; }
	template <> unsigned int GetTypeNameHash< unsigned long >() { return 0x815d47a; }
	template <> const Type* GetType< wchar_t >() { return clcppTypePtrs[269]; }
	template <> unsigned int GetTypeNameHash< wchar_t >() { return 0x311714bf; }
	template <> const Type* GetType< short >() { return clcppTypePtrs[270]; }
	template <> unsigned int GetTypeNameHash< short >() { return 0x34a7768f; }
	template <> const Type* GetType< long >() { return clcppTypePtrs[271]; }
	template <> unsigned int GetTypeNameHash< long >() { return 0x38da33ef; }
	template <> const Type* GetType< unsigned char >() { return clcppTypePtrs[272]; }
	template <> unsigned int GetTypeNameHash< unsigned char >() { return 0x49400eb8; }
	template <> const Type* GetType< long long >() { return clcppTypePtrs[273]; }
	template <> unsigned int GetTypeNameHash< long long >() { return 0x532220b8; }
	template <> const Type* GetType< double >() { return clcppTypePtrs[274]; }
	template <> unsigned int GetTypeNameHash< double >() { return 0x68e6d3ff; }
	template <> const Type* GetType< bool >() { return clcppTypePtrs[275]; }
	template <> unsigned int GetTypeNameHash< bool >() { return 0x8fd0d24a; }
	template <> const Type* GetType< unsigned short >() { return clcppTypePtrs[276]; }
	template <> unsigned int GetTypeNameHash< unsigned short >() { return 0x919d1bf1; }
	template <> const Type* GetType< unsigned int >() { return clcppTypePtrs[277]; }
	template <> unsigned int GetTypeNameHash< unsigned int >() { return 0x91ee210a; }
	template <> const Type* GetType< float >() { return clcppTypePtrs[278]; }
	template <> unsigned int GetTypeNameHash< float >() { return 0x95fb9fe8; }
	template <> const Type* GetType< char >() { return clcppTypePtrs[279]; }
	template <> unsigned int GetTypeNameHash< char >() { return 0xb7155e0b; }
	template <> const Type* GetType< unsigned long long >() { return clcppTypePtrs[280]; }
	template <> unsigned int GetTypeNameHash< unsigned long long >() { return 0xc058aa24; }
	template <> const Type* GetType< int >() { return clcppTypePtrs[281]; }
	...
	template <> const Type* GetType< dooms::eDObjectFlag >() { return clcppTypePtrs[257]; }
	template <> unsigned int GetTypeNameHash< dooms::eDObjectFlag >() { return 0x774eb9ef; }
	template <> const Type* GetType< dooms::eRenderingFlag >() { return clcppTypePtrs[259]; }
