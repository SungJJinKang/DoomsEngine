...
void clcppInitGetType(const clcpp::Database* db)
{
	...
	if (db != 0)
	{
		...
		clcppTypePtrs[90] = db->GetType(0x5bad86b5);
		...
		clcppTypePtrs[200] = db->GetType(0xd76065e6);
...
namespace clcpp
{
	...
	template <> const Type* GetType< dooms::graphics::CubemapTexture >() { return clcppTypePtrs[90]; }
	...
	template <> const Type* GetType< dooms::TransformCoreData >() { return clcppTypePtrs[200]; }
