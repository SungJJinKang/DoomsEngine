...
void clcppInitGetType(const clcpp::Database* db)
{
	...
	if (db != 0)
	{
		...
		clcppTypePtrs[199] = db->GetType(0xd777e004);
		clcppTypePtrs[200] = db->GetType(0xd85c112c);
		clcppTypePtrs[201] = db->GetType(0xd89ac106);
		clcppTypePtrs[202] = db->GetType(0xd94c8018);
		clcppTypePtrs[203] = db->GetType(0xd95e1fd8);
		clcppTypePtrs[204] = db->GetType(0xd98bf230);
		clcppTypePtrs[205] = db->GetType(0xda054820);
		clcppTypePtrs[206] = db->GetType(0xdaa271be);
...
namespace clcpp
{
	...
	template <> const Type* GetType< dooms::graphics::PIPManager >() { return clcppTypePtrs[199]; }
	template <> unsigned int GetTypeNameHash< dooms::graphics::PIPManager >() { return 0xd777e004; }
	template <> const Type* GetType< dooms::graphics::MeshNode >() { return clcppTypePtrs[200]; }
	template <> unsigned int GetTypeNameHash< dooms::graphics::MeshNode >() { return 0xd85c112c; }
	template <> const Type* GetType< dooms::graphics::GraphicsAPILoader >() { return clcppTypePtrs[201]; }
	template <> unsigned int GetTypeNameHash< dooms::graphics::GraphicsAPILoader >() { return 0xd89ac106; }
	template <> const Type* GetType< dooms::Transform >() { return clcppTypePtrs[202]; }
	template <> unsigned int GetTypeNameHash< dooms::Transform >() { return 0xd94c8018; }
	template <> const Type* GetType< dooms::time::MainTimer >() { return clcppTypePtrs[203]; }
	template <> unsigned int GetTypeNameHash< dooms::time::MainTimer >() { return 0xd95e1fd8; }
	template <> const Type* GetType< dooms::physics::Physics_Server >() { return clcppTypePtrs[204]; }
	template <> unsigned int GetTypeNameHash< dooms::physics::Physics_Server >() { return 0xd98bf230; }
	template <> const Type* GetType< dooms::GameCore >() { return clcppTypePtrs[205]; }
	template <> unsigned int GetTypeNameHash< dooms::GameCore >() { return 0xda054820; }
	template <> const Type* GetType< dooms::assetImporter::AssetImporterWorkerManager >() { return clcppTypePtrs[206]; }
