...
void clcppInitGetType(const clcpp::Database* db)
{
	...
	if (db != 0)
	{
		...
		clcppTypePtrs[193] = db->GetType(0xcd89c68c);
		clcppTypePtrs[194] = db->GetType(0xcfb8df5d);
		clcppTypePtrs[195] = db->GetType(0xcfec08ae);
		clcppTypePtrs[196] = db->GetType(0xd371a678);
		clcppTypePtrs[197] = db->GetType(0xd7199f49);
		clcppTypePtrs[198] = db->GetType(0xd72d9105);
		clcppTypePtrs[199] = db->GetType(0xd76065e6);
		...
		clcppTypePtrs[214] = db->GetType(0xde2407e8);
...
namespace clcpp
{
	...
	template <> const Type* GetType< ::ImDrawDataBuilder >() { return clcppTypePtrs[193]; }
	template <> unsigned int GetTypeNameHash< ::ImDrawDataBuilder >() { return 0xcd89c68c; }
	template <> const Type* GetType< ::ImGuiTableColumnSortSpecs >() { return clcppTypePtrs[194]; }
	template <> unsigned int GetTypeNameHash< ::ImGuiTableColumnSortSpecs >() { return 0xcfb8df5d; }
	template <> const Type* GetType< ::ImFontGlyphRangesBuilder >() { return clcppTypePtrs[195]; }
	template <> unsigned int GetTypeNameHash< ::ImFontGlyphRangesBuilder >() { return 0xcfec08ae; }
	template <> const Type* GetType< dooms::assetImporter::AssetImporterWorker_Font >() { return clcppTypePtrs[196]; }
	template <> unsigned int GetTypeNameHash< dooms::assetImporter::AssetImporterWorker_Font >() { return 0xd371a678; }
	template <> const Type* GetType< dooms::Collider3DComponent >() { return clcppTypePtrs[197]; }
	template <> unsigned int GetTypeNameHash< dooms::Collider3DComponent >() { return 0xd7199f49; }
	template <> const Type* GetType< ::ImGuiColorMod >() { return clcppTypePtrs[198]; }
	template <> unsigned int GetTypeNameHash< ::ImGuiColorMod >() { return 0xd72d9105; }
	template <> const Type* GetType< dooms::TransformCoreData >() { return clcppTypePtrs[199]; }
	...
	template <> const Type* GetType< dooms::graphics::BufferID >() { return clcppTypePtrs[214]; }
