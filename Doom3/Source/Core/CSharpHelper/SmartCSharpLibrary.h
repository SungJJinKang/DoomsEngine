...
namespace doom
{
	...
	public :
		...
		bool CallFunction(const char* functionName, RETURN_TYPE& returnValue, Args&&... args);

	};

	template <typename RETURN_TYPE, typename ... Args>
	bool SmartCSharpLibrary::CallFunction(const char* const functionName, RETURN_TYPE& returnValue, Args&&... args)
	{
