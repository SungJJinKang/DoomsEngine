...
#ifdef _Source_Core_IO_AssetImporter_AssetImporterWorker_AssetImporterWorker_Audio_reflection_h

#error "_Source_Core_IO_AssetImporter_AssetImporterWorker_AssetImporterWorker_Audio_reflection_h already included, missing '#pragma once' in _Source_Core_IO_AssetImporter_AssetImporterWorker_AssetImporterWorker_Audio_reflection_h"

#endif

#define _Source_Core_IO_AssetImporter_AssetImporterWorker_AssetImporterWorker_Audio_reflection_h
...
public : \
inline static const unsigned long int BASE_CHAIN_LIST[] { 2429147574, 1388311841, 3969188510 }; \
