...
// SourceFilePath : __Source_Core_IO_AssetImporter_AssetImporterWorker_AssetImporterWorker_Text_reflection_h


#ifdef __Source_Core_IO_AssetImporter_AssetImporterWorker_AssetImporterWorker_Text_reflection_h

#error "__Source_Core_IO_AssetImporter_AssetImporterWorker_AssetImporterWorker_Text_reflection_h already included, missing '#pragma once' in __Source_Core_IO_AssetImporter_AssetImporterWorker_AssetImporterWorker_Text_reflection_h"

#endif

#define __Source_Core_IO_AssetImporter_AssetImporterWorker_AssetImporterWorker_Text_reflection_h
...
public : \
inline static const unsigned long int BASE_CHAIN_LIST[] { 4103986806, 1388311841, 3969188510 }; \
