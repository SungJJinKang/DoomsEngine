...
{
	if (this->IsWorldBVhColliderCacheDirty.GetIsDirty(false) == true)
	{//Only when WorldAABB is updated,
		doom::BVH_Node_Container<ColliderType>::UpdateBVH_Node(this->GetWorldBVhColliderCacheByReference());
	}
