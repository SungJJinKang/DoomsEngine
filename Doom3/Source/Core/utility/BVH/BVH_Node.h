...
namespace dooms
{
	...
	struct BVH_Node : public TreeNode
	{
		...
		dooms::physics::Collider* mCollider;
	...
	using BVH_Node2D = typename BVH_Node<dooms::physics::AABB2D>;
	using BVH_Node3D = typename BVH_Node<dooms::physics::AABB3D>;
	using BVH_NodeSphere = typename BVH_Node<dooms::physics::Sphere>;

	extern template struct BVH_Node<dooms::physics::AABB2D>;
	extern template struct BVH_Node<dooms::physics::AABB3D>;
	extern template struct BVH_Node<dooms::physics::Sphere>;
