...
#ifdef _Source_Core_Physics_Collider_Sphere_reflection_h

#error "_Source_Core_Physics_Collider_Sphere_reflection_h already included, missing '#pragma once' in _Source_Core_Physics_Collider_Sphere_reflection_h"

#endif

#define _Source_Core_Physics_Collider_Sphere_reflection_h
