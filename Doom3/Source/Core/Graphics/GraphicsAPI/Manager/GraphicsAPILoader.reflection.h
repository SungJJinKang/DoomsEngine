...
// SourceFilePath : __Source_Core_Graphics_GraphicsAPI_GraphicsAPILoader_reflection_h


#ifdef __Source_Core_Graphics_GraphicsAPI_GraphicsAPILoader_reflection_h

#error "__Source_Core_Graphics_GraphicsAPI_GraphicsAPILoader_reflection_h already included, missing '#pragma once' in __Source_Core_Graphics_GraphicsAPI_GraphicsAPILoader_reflection_h"

#endif

#define __Source_Core_Graphics_GraphicsAPI_GraphicsAPILoader_reflection_h
