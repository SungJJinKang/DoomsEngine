...
namespace doom
{
	...
	namespace graphics
	{
		...
		public:
			...
			FORCE_INLINE int GetUniformLocation(const char* str)
			{
				return glGetUniformLocation(mProgramID, str);
			}

			FORCE_INLINE static void SetBool(int location, bool value1)
			{
			...
			FORCE_INLINE static void SetBool(int location, bool value1, bool value2)
			{
			...
			FORCE_INLINE static void SetBool(int location, bool value1, bool value2, bool value3)
			{
			...
			FORCE_INLINE static void SetBool(int location, bool value1, bool value2, bool value3, bool value4)
			{
			...
			FORCE_INLINE static void SetInt(int location, int value1)
			{
			...
			FORCE_INLINE static void SetInt(int location, int value1, int value2)
			{
			...
			FORCE_INLINE static void SetInt(int location, int value1, int value2, int value3)
			{
			...
			FORCE_INLINE static void SetInt(int location, int value1, int value2, int value3, int value4)
			{
			...
			FORCE_INLINE static void SetFloat(int location, float value1)
			{
			...
			FORCE_INLINE static void SetFloat(int location, float value1, float value2)
			{
			...
			FORCE_INLINE static void SetFloat(int location, float value1, float value2, float value3)
			{
			...
			FORCE_INLINE static void SetFloat(int location, float value1, float value2, float value3, float value4)
			{
			...
			FORCE_INLINE static void SetMatrix1x1(int location, const math::Matrix1x1& matrix1x1)
			{
			...
			FORCE_INLINE static void SetMatrix2x2(int location, const math::Matrix2x2& matrix2x2)
			{
			...
			FORCE_INLINE static void SetMatrix3x3(int location, const math::Matrix3x3& matrix3x3)
			{
			...
			FORCE_INLINE static void SetMatrix4x4(int location, const math::Matrix4x4& matrix4x4)
			{
			...
			FORCE_INLINE static void SetVector1(int location, const math::Vector1& vector1)
			{
			...
			FORCE_INLINE static void SetVector2(int location, const math::Vector2& vector2)
			{
			...
			FORCE_INLINE static void SetVector3(int location, const math::Vector3& vector3)
			{
			...
			FORCE_INLINE static void SetVector4(int location, const math::Vector4& vector4)
			{
