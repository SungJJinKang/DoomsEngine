	...
	namespace graphics
	{
		...
		public:
			...
			inline void BlitBufferTo(unsigned int DrawFrameBufferId, unsigned int srcX0, unsigned int srcY0, unsigned int srcX1, unsigned int srcY1
				, unsigned int dstX0, unsigned int dstY0, unsigned int dstX1, unsigned int dstY1, GraphicsAPI::eBufferType mask, eImageInterpolation filter) noexcept
			{
			...
			void AttachRenderBuffer(GraphicsAPI::eBufferType renderBufferType);
			void AttachTextureBuffer(GraphicsAPI::eBufferType frameBufferType);
