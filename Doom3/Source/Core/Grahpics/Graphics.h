...
namespace Doom
{
	...
	public:
		...
		enum class BufferMode : unsigned int
		{
		...
		static inline void ReadBuffer(BufferMode mode)
		{
			glReadBuffer(static_cast<unsigned int>(mode));
		}
		static inline void WriteBuffer(BufferMode mode)
		{
			glDrawBuffer(static_cast<unsigned int>(mode));
		}
		static inline void CullFace(CullFaceMode mode)
		{
			glCullFace(static_cast<unsigned int>(mode));
		}

		static inline void ClearColor(float r, float g, float b, float a)
		{
		...
		static inline void ClearStencil(unsigned int stencil)
		{
		...
		static inline void Clear(ClearMask mask1)
		{
			glClear(static_cast<unsigned int>(mask1));
		}
		static inline void Clear(ClearMask mask1, ClearMask mask2)
		{
			glClear(static_cast<unsigned int>(mask1) | static_cast<unsigned int>(mask2));
		}
		static inline void Clear(ClearMask mask1, ClearMask mask2, ClearMask mask3)
		{
		...
		static inline void Enable(Capability c)
		{
			glEnable(static_cast<unsigned int>(c));
		}

		static inline void Disable(Capability c)
		{
		...
		static inline void BlendFunc(SourceFactor sourceFactor, DestinationFactor destinationFactor)
		{
			glBlendFunc(static_cast<unsigned int>(sourceFactor), static_cast<unsigned int>(destinationFactor));
		}

		enum class FrontFaceMode : unsigned int 
		{
			CW = GL_CW,
			CCW = GL_CCW
		...
		static inline void FrontFace(FrontFaceMode faceMode)
		{
