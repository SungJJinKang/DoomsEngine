...
public: typedef dooms::MeshVertexData Current;
...
public: typedef dooms::ThreeDModelMesh Current;
...
public: typedef dooms::ThreeDModelNode Current;
...
public: typedef dooms::asset::ThreeDModelAsset Current;
