...
// SourceFilePath : __Source_Core_Asset_AssetManager_AssetContainer_reflection_h


#ifdef __Source_Core_Asset_AssetManager_AssetContainer_reflection_h

#error "__Source_Core_Asset_AssetManager_AssetContainer_reflection_h already included, missing '#pragma once' in __Source_Core_Asset_AssetManager_AssetContainer_reflection_h"

#endif

#define __Source_Core_Asset_AssetManager_AssetContainer_reflection_h
...
#undef INHERITANCE_INFORMATION_dooms__asset__AssetContainer
#define INHERITANCE_INFORMATION_dooms__asset__AssetContainer \
public : \
inline static const unsigned long int BASE_CHAIN_LIST[] { 2052131787, 3969188510 }; \
...
#undef CLONE_OBJECT_dooms__asset__AssetContainer
#define CLONE_OBJECT_dooms__asset__AssetContainer \
public : \
virtual dooms::DObject* CloneObject() const \
{ \
	dooms::DObject* clonedObject = nullptr; \
	/* std::vector<std::unique_ptr> can make false positive for std::is_copy_constructible<std::vector<std::unique_ptr>>::value. So Please explicitly delete copy constructor if you have this type variable */ \
	if constexpr( (std::is_copy_constructible<dooms::asset::AssetContainer>::value == true) && (std::is_base_of<dooms::DObject, dooms::asset::AssetContainer>::value == true) ) \
	{ \
		 clonedObject = dooms::CreateDObject<dooms::asset::AssetContainer>(*this); \
	} \
...
INHERITANCE_INFORMATION_dooms__asset__AssetContainer \
CLONE_OBJECT_dooms__asset__AssetContainer \
