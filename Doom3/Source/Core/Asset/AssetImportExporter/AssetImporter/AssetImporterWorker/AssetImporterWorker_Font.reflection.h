...
// SourceFilePath : __Source_Core_Asset_AssetImportExporter_AssetImporter_AssetImporterWorker_AssetImporterWorker_Font_reflection_h


#ifdef __Source_Core_Asset_AssetImportExporter_AssetImporter_AssetImporterWorker_AssetImporterWorker_Font_reflection_h

#error "__Source_Core_Asset_AssetImportExporter_AssetImporter_AssetImporterWorker_AssetImporterWorker_Font_reflection_h already included, missing '#pragma once' in __Source_Core_Asset_AssetImportExporter_AssetImporter_AssetImporterWorker_AssetImporterWorker_Font_reflection_h"

#endif

#define __Source_Core_Asset_AssetImportExporter_AssetImporter_AssetImporterWorker_AssetImporterWorker_Font_reflection_h
...
public : \
inline static const unsigned long int BASE_CHAIN_LIST[] { 3547440760, 1388311841, 3251103914, 3969188510 }; \
