...
// SourceFilePath : __Source_Core_Asset_Asset_reflection_h


#ifdef __Source_Core_Asset_Asset_reflection_h

#error "__Source_Core_Asset_Asset_reflection_h already included, missing '#pragma once' in __Source_Core_Asset_Asset_reflection_h"

#endif

#define __Source_Core_Asset_Asset_reflection_h
...
public : \
inline static const unsigned long int BASE_CHAIN_LIST[] { 2982024308, 3969188510 }; \
...
#undef CLONE_OBJECT_dooms__asset__Asset
#define CLONE_OBJECT_dooms__asset__Asset \
public : \
virtual dooms::DObject* CloneObject() const \
{ \
	dooms::DObject* clonedObject = nullptr; \
	/* std::vector<std::unique_ptr> can make false positive for std::is_copy_constructible<std::vector<std::unique_ptr>>::value. So Please explicitly delete copy constructor if you have this type variable */ \
	if constexpr( (std::is_copy_constructible<dooms::asset::Asset>::value == true) && (std::is_base_of<dooms::DObject, dooms::asset::Asset>::value == true) ) \
	{ \
		 clonedObject = dooms::CreateDObject<dooms::asset::Asset>(*this); \
	} \
...
public : \
typedef dooms::asset::Asset Current;
...
CLONE_OBJECT_dooms__asset__Asset \
