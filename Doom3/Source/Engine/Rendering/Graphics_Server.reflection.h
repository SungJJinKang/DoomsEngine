...
// SourceFilePath : __Source_Engine_Rendering_Graphics_Server_reflection_h


#ifdef __Source_Engine_Rendering_Graphics_Server_reflection_h

#error "__Source_Engine_Rendering_Graphics_Server_reflection_h already included, missing '#pragma once' in __Source_Engine_Rendering_Graphics_Server_reflection_h"

#endif

#define __Source_Engine_Rendering_Graphics_Server_reflection_h
...
public : \
inline static const unsigned long int BASE_CHAIN_LIST[] { 385065569, 3668408939, 3969188510 }; \
...
#undef CLONE_OBJECT_dooms__graphics__Graphics_Server
#define CLONE_OBJECT_dooms__graphics__Graphics_Server \
public : \
virtual dooms::DObject* CloneObject() const \
{ \
	dooms::DObject* clonedObject = nullptr; \
	/* std::vector<std::unique_ptr> can make false positive for std::is_copy_constructible<std::vector<std::unique_ptr>>::value. So Please explicitly delete copy constructor if you have this type variable */ \
	if constexpr( (std::is_copy_constructible<dooms::graphics::Graphics_Server>::value == true) && (std::is_base_of<dooms::DObject, dooms::graphics::Graphics_Server>::value == true) ) \
	{ \
		 clonedObject = dooms::CreateDObject<dooms::graphics::Graphics_Server>(*this); \
	} \
...
public : \
typedef dooms::graphics::Graphics_Server Current;
...
CLONE_OBJECT_dooms__graphics__Graphics_Server \
