...
void Camera::UpdateUniformBufferObject(const bool force)
{
	...
	{//if this camera is mainCamera
		...
		dooms::graphics::UniformBufferObjectManager::GetSingleton()->GetUniformBufferObject(GLOBAL_UNIFORM_BLOCK_NAME)->UpdateDataToGPU((void*)projectionMatrix.data(), sizeof(projectionMatrix), dooms::graphics::eUniformBlock_Global::projection);
		dooms::graphics::UniformBufferObjectManager::GetSingleton()->GetUniformBufferObject(GLOBAL_UNIFORM_BLOCK_NAME)->UpdateDataToGPU((void*)&mClippingPlaneNear, sizeof(FLOAT32), graphics::eUniformBlock_Global::camNear);
		dooms::graphics::UniformBufferObjectManager::GetSingleton()->GetUniformBufferObject(GLOBAL_UNIFORM_BLOCK_NAME)->UpdateDataToGPU((void*)&mClippingPlaneFar, sizeof(FLOAT32), graphics::eUniformBlock_Global::camFar);
		...
		dooms::graphics::UniformBufferObjectManager::GetSingleton()->GetUniformBufferObject(GLOBAL_UNIFORM_BLOCK_NAME)->UpdateDataToGPU((void*)viewMatrix.data(), sizeof(viewMatrix), graphics::eUniformBlock_Global::view);
		dooms::graphics::UniformBufferObjectManager::GetSingleton()->GetUniformBufferObject(GLOBAL_UNIFORM_BLOCK_NAME)->UpdateDataToGPU((void*)camPos.data(), sizeof(camPos), graphics::eUniformBlock_Global::camPos);
		dooms::graphics::UniformBufferObjectManager::GetSingleton()->GetUniformBufferObject(GLOBAL_UNIFORM_BLOCK_NAME)->UpdateDataToGPU((void*)viewProjectionMatrix.data(), sizeof(viewProjectionMatrix), graphics::eUniformBlock_Global::viewProjection);
