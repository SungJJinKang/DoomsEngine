...
public: inline static const unsigned long int BASE_CHAIN_LIST[] { 1852129323, 2741420880, 1503232071, 3040581954, 3969188510 }; \
...
public: typedef dooms::DirectionalLight Current;
