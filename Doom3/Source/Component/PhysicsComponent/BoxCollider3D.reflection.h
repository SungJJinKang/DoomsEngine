...
// SourceFilePath : __Source_Component_PhysicsComponent_BoxCollider3D_reflection_h


#ifdef __Source_Component_PhysicsComponent_BoxCollider3D_reflection_h

#error "__Source_Component_PhysicsComponent_BoxCollider3D_reflection_h already included, missing '#pragma once' in __Source_Component_PhysicsComponent_BoxCollider3D_reflection_h"

#endif

#define __Source_Component_PhysicsComponent_BoxCollider3D_reflection_h
...
public : \
inline static const unsigned long int BASE_CHAIN_LIST[] { 762801057, 3608780617, 960295289, 3040581954, 3969188510 }; \
...
#undef CLONE_OBJECT_dooms__BoxCollider3D
#define CLONE_OBJECT_dooms__BoxCollider3D \
public : \
virtual dooms::DObject* CloneObject() const \
{ \
	dooms::DObject* clonedObject = nullptr; \
	/* std::vector<std::unique_ptr> can make false positive for std::is_copy_constructible<std::vector<std::unique_ptr>>::value. So Please explicitly delete copy constructor if you have this type variable */ \
	if constexpr( (std::is_copy_constructible<dooms::BoxCollider3D>::value == true) && (std::is_base_of<dooms::DObject, dooms::BoxCollider3D>::value == true) ) \
	{ \
		 clonedObject = dooms::CreateDObject<dooms::BoxCollider3D>(*this); \
	} \
...
public : \
typedef dooms::BoxCollider3D Current;
...
CLONE_OBJECT_dooms__BoxCollider3D \
