...
public : \
inline static const unsigned long int BASE_CHAIN_LIST[] { 1503232071, 3040581954, 3969188510 }; \
...
#undef CLONE_OBJECT_dooms__ServerComponent
#define CLONE_OBJECT_dooms__ServerComponent \
public : \
virtual dooms::DObject* CloneObject() const \
{ \
	dooms::DObject* clonedObject = nullptr; \
	/* std::vector<std::unique_ptr> can make false positive for std::is_copy_constructible<std::vector<std::unique_ptr>>::value. So Please explicitly delete copy constructor if you have this type variable */ \
	if constexpr( (std::is_copy_constructible<dooms::ServerComponent>::value == true) && (std::is_base_of<dooms::DObject, dooms::ServerComponent>::value == true) ) \
	{ \
		 clonedObject = dooms::CreateDObject<dooms::ServerComponent>(*this); \
	} \
...
public : \
typedef dooms::ServerComponent Current;
...
CLONE_OBJECT_dooms__ServerComponent \
