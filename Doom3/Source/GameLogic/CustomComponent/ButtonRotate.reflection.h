...
// SourceFilePath : __Source_GameLogic_CustomComponent_ButtonRotate_reflection_h


#ifdef __Source_GameLogic_CustomComponent_ButtonRotate_reflection_h

#error "__Source_GameLogic_CustomComponent_ButtonRotate_reflection_h already included, missing '#pragma once' in __Source_GameLogic_CustomComponent_ButtonRotate_reflection_h"

#endif

#define __Source_GameLogic_CustomComponent_ButtonRotate_reflection_h
