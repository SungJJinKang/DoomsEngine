...
// SourceFilePath : __Source_GameLogic_CustomComponent_ExportTextureTester_reflection_h


#ifdef __Source_GameLogic_CustomComponent_ExportTextureTester_reflection_h

#error "__Source_GameLogic_CustomComponent_ExportTextureTester_reflection_h already included, missing '#pragma once' in __Source_GameLogic_CustomComponent_ExportTextureTester_reflection_h"

#endif

#define __Source_GameLogic_CustomComponent_ExportTextureTester_reflection_h
...
public : \
inline static const unsigned long int BASE_CHAIN_LIST[] { 2869152404, 3040581954, 3969188510 }; \
...
#undef CLONE_OBJECT_dooms__ExportTextureTester
#define CLONE_OBJECT_dooms__ExportTextureTester \
public : \
virtual dooms::DObject* CloneObject() const \
{ \
	dooms::DObject* clonedObject = nullptr; \
	/* std::vector<std::unique_ptr> can make false positive for std::is_copy_constructible<std::vector<std::unique_ptr>>::value. So Please explicitly delete copy constructor if you have this type variable */ \
	if constexpr( (std::is_copy_constructible<dooms::ExportTextureTester>::value == true) && (std::is_base_of<dooms::DObject, dooms::ExportTextureTester>::value == true) ) \
	{ \
		 clonedObject = dooms::CreateDObject<dooms::ExportTextureTester>(*this); \
	} \
...
public : \
typedef dooms::ExportTextureTester Current;
...
CLONE_OBJECT_dooms__ExportTextureTester \
