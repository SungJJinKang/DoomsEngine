...
void dooms::PhysicsDebuggerController::UpdateComponent()
{
    ...
    if (dooms::userinput::UserInput_Server::GetKeyUp(dooms::graphics::GraphicsAPIInput::eKEY_CODE::KEY_F7))
    {
        dooms::physics::Physics_Setting::SetIsPhysicsOn(!dooms::physics::Physics_Setting::GetIsPhysicsOn());
    }

    if (dooms::userinput::UserInput_Server::GetKeyUp(dooms::graphics::GraphicsAPIInput::eKEY_CODE::KEY_F8))
    {
