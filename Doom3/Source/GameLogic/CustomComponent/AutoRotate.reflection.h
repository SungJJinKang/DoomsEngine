...
// SourceFilePath : __Source_GameLogic_CustomComponent_AutoRotate_reflection_h


#ifdef __Source_GameLogic_CustomComponent_AutoRotate_reflection_h

#error "__Source_GameLogic_CustomComponent_AutoRotate_reflection_h already included, missing '#pragma once' in __Source_GameLogic_CustomComponent_AutoRotate_reflection_h"

#endif

#define __Source_GameLogic_CustomComponent_AutoRotate_reflection_h
...
public : \
inline static const unsigned long int BASE_CHAIN_LIST[] { 1158111581, 3040581954, 3969188510 }; \
...
#undef CLONE_OBJECT_dooms__AutoRotate
#define CLONE_OBJECT_dooms__AutoRotate \
public : \
virtual dooms::DObject* CloneObject() const \
{ \
	dooms::DObject* clonedObject = nullptr; \
	/* std::vector<std::unique_ptr> can make false positive for std::is_copy_constructible<std::vector<std::unique_ptr>>::value. So Please explicitly delete copy constructor if you have this type variable */ \
	if constexpr( (std::is_copy_constructible<dooms::AutoRotate>::value == true) && (std::is_base_of<dooms::DObject, dooms::AutoRotate>::value == true) ) \
	{ \
		 clonedObject = dooms::CreateDObject<dooms::AutoRotate>(*this); \
	} \
...
public : \
typedef dooms::AutoRotate Current;
...
CLONE_OBJECT_dooms__AutoRotate \
