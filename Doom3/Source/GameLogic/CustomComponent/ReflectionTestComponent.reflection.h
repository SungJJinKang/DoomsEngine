...
#ifdef _Source_GameLogic_CustomComponent_ReflectionTestComponent_reflection_h

#error "_Source_GameLogic_CustomComponent_ReflectionTestComponent_reflection_h already included, missing '#pragma once' in _Source_GameLogic_CustomComponent_ReflectionTestComponent_reflection_h"

#endif

#define _Source_GameLogic_CustomComponent_ReflectionTestComponent_reflection_h
