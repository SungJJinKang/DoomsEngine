...
// SourceFilePath : __Source_GameLogic_CustomComponent_BoxAdder_reflection_h


#ifdef __Source_GameLogic_CustomComponent_BoxAdder_reflection_h

#error "__Source_GameLogic_CustomComponent_BoxAdder_reflection_h already included, missing '#pragma once' in __Source_GameLogic_CustomComponent_BoxAdder_reflection_h"

#endif

#define __Source_GameLogic_CustomComponent_BoxAdder_reflection_h
...
public : \
inline static const unsigned long int BASE_CHAIN_LIST[] { 996599837, 3040581954, 3969188510 }; \
