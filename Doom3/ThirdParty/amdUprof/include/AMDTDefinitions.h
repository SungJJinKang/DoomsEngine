...
// codes used by AMDuProf APIs.

#ifndef _AMDTDEFINITIONS_H_
#define _AMDTDEFINITIONS_H_

/** \file AMDTDefinitions.h
\brief Basic data type definitions and error codes used by the AMD uProf Power Profiler APIs
*/
...
typedef AMDTUInt8 bool;
#endif
#endif // for __linux__ or __FreeBSD__
...
#define AMDT_ERROR_FALSE                        AMDTResult(1)
...
/** Could not start the profile session as counter enabled.
*/
...
/**  Unable to configure the thread profile
*/
#define AMDT_WARNING_THREAD_PROFILE_NO_SET       AMDTResult(0x80080026)
#ifdef __cplusplus
}
#endif

#define AMDT_CPU_PROFILE_COLLECT_RUNNING        AMDTResult(0x80080027)

/**  Profile duration exceeded
*/
#define AMDT_ERROR_PROFILE_DURATION_COMPLETED   AMDTResult(0x80080028)
